...
namespace System.Binary
{
    public static partial class CustomBinary
    {
        ...
        static readonly Type IgnoreAttribute = typeof(BinaryIgnoreAttribute);
        ...
        internal static void Build()
        {
            ...
            foreach (var asm in asms)
            {
                ...
                {
                    var includes = type.GetCustomAttributes(typeof(BinaryIncludeAttribute), false)
                        .Cast<BinaryIncludeAttribute>().ToList();
