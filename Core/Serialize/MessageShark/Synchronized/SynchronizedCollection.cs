...
namespace System.Collections.Generic
{
    ...
    public class SynchronizedCollection<T> : IList<T>, IList
    {
            ...
            set
            {
                lock (this.sync)
                {
                    if (index < 0 || index >= this.items.Count)
                        throw new ArgumentOutOfRangeException("index", index, this.items.Count.ToString());
        ...
        public void RemoveAt(int index)
        {
            ...
            {
                if (index < 0 || index >= this.items.Count)
                    throw new ArgumentOutOfRangeException("index", index, "ValueMustBeInRange " + this.items.Count.ToString());
                this.RemoveItem(index);
            }
        }
        ...
        static void VerifyValueType(object value)
        {
            ...
            {
                throw new ArgumentException("SynchronizedCollectionWrongType1 = " +  value.GetType().FullName);
            }
        }
    }
}
