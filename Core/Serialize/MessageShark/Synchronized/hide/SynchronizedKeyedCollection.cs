...
namespace System.Collections.Generic
{
    ...
    public abstract class SynchronizedKeyedCollection<K, T> : SynchronizedCollection<T>
    {
            ...
            : base(syncRoot)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("dictionaryCreationThreshold", dictionaryCreationThreshold, "ValueMustBeInRange " + int.MaxValue.ToString()); 
            }
        ...
        void AddKey(K key, T item)
        {
            ...
            else
            {
                if (this.Contains(key))
                    throw new ArgumentException("CannotAddTwoItemsWithTheSameKeyToSynchronizedKeyedCollection0");
        ...
        protected void ChangeItemKey(T item, K newKey)
        {
            ...
            if (!this.ContainsItem(item))
                throw new ArgumentException("ItemDoesNotExistInSynchronizedKeyedCollection0");
