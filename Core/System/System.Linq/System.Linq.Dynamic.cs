...
#pragma warning restore 0219
        ...
        System.Linq.Expressions.Expression GenerateConditional(System.Linq.Expressions.Expression test, System.Linq.Expressions.Expression expr1, System.Linq.Expressions.Expression expr2, int errorPos)
        {
        ...
        System.Linq.Expressions.Expression GenerateConversion(System.Linq.Expressions.Expression expr, Type type, int errorPos)
        {
        ...
        System.Linq.Expressions.Expression ParseAggregate(System.Linq.Expressions.Expression instance, Type elementType, string methodName, int errorPos)
        {
        ...
        void CheckAndPromoteOperand(Type signatures, string opName, ref System.Linq.Expressions.Expression expr, int errorPos)
        {
        ...
        void CheckAndPromoteOperands(Type signatures, string opName, ref System.Linq.Expressions.Expression left, ref System.Linq.Expressions.Expression right, int errorPos)
        {
        ...
        Exception IncompatibleOperandsError(string opName, System.Linq.Expressions.Expression left, System.Linq.Expressions.Expression right, int pos)
        {
            return ParseError(pos, Res.IncompatibleOperands,
                opName, GetTypeName(left.Type), GetTypeName(right.Type));
        }

        System.Reflection.MemberInfo FindPropertyOrField(Type type, string memberName, bool staticAccess)
        {
        ...
        int FindMethod(Type type, string methodName, bool staticAccess, System.Linq.Expressions.Expression[] args, out System.Reflection.MethodBase method)
        {
            System.Reflection.BindingFlags flags = System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.DeclaredOnly |
                (staticAccess ? System.Reflection.BindingFlags.Static : System.Reflection.BindingFlags.Instance);
            foreach (Type t in SelfAndBaseTypes(type)) {
        ...
        int FindIndexer(Type type, System.Linq.Expressions.Expression[] args, out System.Reflection.MethodBase method)
        {
            foreach (Type t in SelfAndBaseTypes(type)) {
        ...
        int FindBestMethod(System.Collections.Generic.IEnumerable<System.Reflection.MethodBase> methods, System.Linq.Expressions.Expression[] args, out System.Reflection.MethodBase method)
        {
        ...
        bool IsApplicable(MethodData method, System.Linq.Expressions.Expression[] args)
        {
        ...
        System.Linq.Expressions.Expression PromoteExpression(System.Linq.Expressions.Expression expr, Type type, bool exact)
        {
        ...
        static bool IsBetterThan(System.Linq.Expressions.Expression[] args, MethodData m1, MethodData m2)
        {
            bool better = false;
            for (int i = 0; i < args.Length; i++) {
